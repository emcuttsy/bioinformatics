...
parser.add_argument('--taxid', help='Pass --taxid if your tree leaves are NCBI taxids instead of accessions', metavar='')
...
for node in tree.get_leaves():
        ...
        if not taxon_name.startswith('MAG'): #THIS IS MY OWN CODE FOR MY OWN STUFF. COMMENT OUT?
            taxon_name = taxon_name.split('.1_')[0]
...
if args.taxid is None: # if taxids are passed, this part is unnecessary
    records = []
